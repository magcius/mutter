                ...
                MetaFrameBorders  *borders)
{
  ...
  /* top right */
  corner_rects[1].x = floor(borders->invisible.left + outer.width - top_right);
  corner_rects[1].y = floor(borders->invisible.top);
  ...
  /* bottom left */
  corner_rects[2].x = floor(borders->invisible.left);
  corner_rects[2].y = floor(borders->invisible.top + outer.height - bottom_left);
  corner_rects[2].width = corner_rects[2].height = ceil(bottom_left);
  ...
  /* bottom right */
  corner_rects[3].x = floor(borders->invisible.left + outer.width - bottom_right);
  corner_rects[3].y = floor(borders->invisible.top + outer.height - bottom_right);
  corner_rects[3].width = corner_rects[3].height = ceil(bottom_right);
