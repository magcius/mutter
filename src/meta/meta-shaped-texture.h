...
CoglHandle meta_shaped_texture_set_pixmap (MetaShapedTexture *stex,
                                           Pixmap             pixmap);
...
void meta_shaped_texture_get_size (MetaShapedTexture *stex,
                                   guint             *width,
                                   guint             *height);

void meta_shaped_texture_as_flattened_data (MetaShapedTexture     *stex,
